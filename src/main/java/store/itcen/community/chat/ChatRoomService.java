...
//    String fileUploadPath = "c:/chatupload/";
	...
	public int countByChatId(String post_id, String buyerId) {
		
		return chatRoomRepository.countByChatId(post_id, buyerId);
	}
	...
	public ChatRoom findByChatId(String post_id, String buyerId) {
		return chatRoomRepository.findByChatId(post_id, buyerId);
	}
	
	public int getId(String post_id, String buyerId) {
		
		return chatRoomRepository.getId(post_id, buyerId);
	}
